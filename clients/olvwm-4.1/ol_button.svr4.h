#if !defined(OL_BUTTON_SVR4_H)
#define OL_BUTTON_SVR4_H
...
#ifdef OW_I18N
void olgx_draw_text(Graphics_info *info, Window win, void *string, int x, int y, int width, int state);
#else
void olgx_draw_text(Graphics_info *info, Window win, char *string, int x, int y, int width, int state);
#endif 
